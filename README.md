...
![News](https://github.com/andrei19386/SocialNetwork/blob/master/news.png)
...
![Search_button_image](https://github.com/andrei19386/SocialNetwork/blob/master/search_button.png)
        	Input the criteria of search. If no criteria typed, all posts of the database will be shown.
![Posts_for_search_criteria](https://github.com/andrei19386/SocialNetwork/blob/master/search.png)
        	On the author profile we can see posts of the author only:
![Author_posts](https://github.com/andrei19386/SocialNetwork/blob/master/author.png)
